<%@ Page Title="Registrations" Language="C#" MasterPageFile="~/USERMASTER/umaster.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="TourismWeb.USERMASTER.WebForm7" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1>Sign Up</h1>
            ...
            <tr>
                ...
                <td align="center"><asp:TextBox ID="txt_pass" type="password" runat="server" placeholder=" Enter Password"></asp:TextBox>
            ...
            <tr>
                <td colspan="2" align="center">
                    <asp:Button ID="btn_submit_user" runat="server" Text="Submit" class="btn btn-primary btn-sm" Font-Bold="True" Font-Size="Large" ForeColor="White" OnClick="btn_submit_user_Click"></asp:Button>&nbsp&nbsp&nbsp
                    <asp:LinkButton style="text-decoration:none" ID="LinkButton_login" runat="server" Font-Bold="True" Font-Underline="True" OnClick="LinkButton_login_Click">Login</asp:LinkButton>
                </td>
            </tr>
        </table>
    </center>
